    ...
    init: function() {
      ...
      $( videos ).each( function( index, el ) {
        $(el).on('loadedmetadata', function(){
          ...
          //if video is paused aka not playing, force it to play
          //this is to try and counteract whatever is stopping the video
          //from playing when in a pinned scrollmagic container
          if ( el.paused ) {
            el.play();
          }
        })
