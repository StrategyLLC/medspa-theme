...
( function( app ) {
  ...
  var COMPONENT = {
    ...
    init: function() {
      ...
      var _this = this;
      $('.ll-google-map').each( function(index, el) {
        var map;
        ...
        function initialize_map() {
          ...
          $.each( locations, function() {
            var newMarker = this;
            var latLng = {lat: parseFloat( newMarker['map_pin_placement']['lat'] ), lng: parseFloat( newMarker['map_pin_placement']['lng'] )};
            ...
            var infoContent = '<div class="infowindow">'+
                              '<address>'+newMarker['address']['street_address']+'<br>'+newMarker['address']['city']+', '+newMarker['address']['state']+' '+newMarker['address']['zip']+'</address>'+
                              '<a class="primary-hover" href="https://www.google.com/maps/place/'+newMarker['map_pin_placement']['address']+'" target="_blank">Get Directions</a></div>';
