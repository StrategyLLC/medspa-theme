...
module.exports = function(grunt) {
  ...
  var jsFileList = [
    ...
    'resources/vendor/scrollmagic/scrollmagic/minified/ScrollMagic.min.js',
    'resources/js/plugins/*.js',
    'resources/js/app.js',
    'resources/js/_*.js',
    'components/**/*.js',
    'resources/vendor/scrollmagic/scrollmagic/minified/plugins/animation.gsap.min.js',
    'resources/vendor/scrollmagic/scrollmagic/minified/plugins/animation.velocity.min.js',
    'resources/vendor/scrollmagic/scrollmagic/minified/plugins/debug.addIndicators.min.js',
    'resources/vendor/scrollmagic/scrollmagic/minified/plugins/jquery.ScrollMagic.min.js'
  ];
